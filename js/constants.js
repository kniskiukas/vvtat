...
const STEPS = {
  ...
  s4_subcategory: {
    ...
    options: [
      ...
      { value: 'preke',        next: 's5_14days', marker: 'B', title: 'Prekė nekokybiška, sugedo arba nepristatyta' },
      ...
      { value: 'reklama',      next: 's5_14days', marker: 'F', title: 'Reklamos paslaugos' },
      { value: 'medicina',     next: 's5_14days', marker: 'G', title: 'Medicinos prekės' },
...
const ENDS = {
  'end-juridinis': {
    ...
    body: 'Valstybinė vartotojų teisių apsaugos tarnyba nagrinėja tik fizinių asmenų (vartotojų) skundus prieš verslą. Juridiniams asmenims rekomenduojame kreiptis į teismą arba tarpininkavimo paslaugas.',
  },
  'end-rrt': {
    icon: '📡',
